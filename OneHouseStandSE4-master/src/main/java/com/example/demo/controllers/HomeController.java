...
public class HomeController {
    ...
    /**
     * Haalt alle panden op van OHS en startup circus.
     *
     * @param model
     * @return een lijst van panden van startup en OHS
     */
    @GetMapping("/aanbod")
    ...
    /**
     * Haalt de id op van het pand, geeft dit pand weer.
     * Indien er geen id is, gaat men ervan uit dat het pand van startup circus is en wordt er een andere pagina weergegeven.
     * @param model
     * @param id
     * @return pand.html of startupcircus.html
     */
    @GetMapping("/pand")
    public String pandDetailForm(Model model, @RequestParam("id") long id) {
        if (id == 0) { //startupcircus pand
